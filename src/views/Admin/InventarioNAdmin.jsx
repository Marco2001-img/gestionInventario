...
export default function InventarioNAdmin() {
  const data = [
                           ...
                           <div className="row">
                             ...
                             <div className="container mt-5">
                               <div className="row">
                                 ...
                                 <div className="col-4">
                                   <div className="card bg-warning-subtle text-success-emphasis">
                                     <div className="card-body text-center">
                                       <p className='h1'>Vendidos++</p>
                                       <p className='h2'>900</p>
                                     </div>
                                   </div>
                                 </div>
       
                                 <div className="col-4">
                                   <div className="card bg-danger-subtle text-success-emphasis">
                                     <div className="card-body text-center">
                                       <p className='h1'>Total de ventas</p>
                                       <p className='h2'>9</p>
                                     </div>
                                   </div>
                                 </div>
